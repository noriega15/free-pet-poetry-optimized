...
const RainbowBridgeTagPage = ({ data, location }) => {
  const siteTitle = data.site.siteMetadata.title
  const allPosts = data.allMarkdownRemark?.nodes || []
  const [selectedTag, setSelectedTag] = useState("RainbowBridge")
...
export const Head = () => <Seo title="Rainbow Bridge" />

export default RainbowBridgeTagPage
