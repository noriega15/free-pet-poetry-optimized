...
const HeartfeltTagPage = ({ data, location }) => {
  const siteTitle = data.site.siteMetadata.title
  const allPosts = data.allMarkdownRemark?.nodes || []
  const [selectedTag, setSelectedTag] = useState("Heartfelt")
...
export const Head = () => <Seo title="Heartfelt" />

export default HeartfeltTagPage
