...
const SympathyTagPage = ({ data, location }) => {
  const siteTitle = data.site.siteMetadata.title
  const allPosts = data.allMarkdownRemark?.nodes || []
  const [selectedTag, setSelectedTag] = useState("Sympathy")
...
export const Head = () => <Seo title="Sympathy" />

export default SympathyTagPage
