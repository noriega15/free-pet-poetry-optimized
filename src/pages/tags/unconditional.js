...
const UnconditionalTagPage = ({ data, location }) => {
  const siteTitle = data.site.siteMetadata.title
  const allPosts = data.allMarkdownRemark?.nodes || []
  const [selectedTag, setSelectedTag] = useState("Unconditional")
...
export const Head = () => <Seo title="Unconditional" />

export default UnconditionalTagPage
