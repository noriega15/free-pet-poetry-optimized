...
const InspirationTagPage = ({ data, location }) => {
  const siteTitle = data.site.siteMetadata.title
  const allPosts = data.allMarkdownRemark?.nodes || []
  const [selectedTag, setSelectedTag] = useState("Inspiration")
...
export const Head = () => <Seo title="Inspiration" />

export default InspirationTagPage
