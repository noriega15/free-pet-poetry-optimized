...
const MemoriesTagPage = ({ data, location }) => {
  const siteTitle = data.site.siteMetadata.title
  const allPosts = data.allMarkdownRemark?.nodes || []
  const [selectedTag, setSelectedTag] = useState("Memories")
...
export const Head = () => <Seo title="Memories" />

export default MemoriesTagPage
