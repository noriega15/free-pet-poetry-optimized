...
const DogsPage = ({ data, location }) => {
  ...
  // Calculate total pages Dogs
  const totalPosts = postsByTopic["Dogs"] ? postsByTopic["Dogs"].length : 0
    ...
    <Layout location={location} title={siteTitle}>
      ...
      >
        <div className="container">
          ...
          <section>
            {topicsArray
              .filter(topicObj => topicObj.topic === "Dogs")
              .map((topicObj, index) => {
                const topic = topicObj.topic
...
export const Head = () => <Seo title="Dogs" />
