...
const CatsPage = ({ data, location }) => {
  ...
  // Calculate total pages Cats
  const totalPosts = postsByTopic["Cats"] ? postsByTopic["Cats"].length : 0
    ...
    <Layout location={location} title={siteTitle}>
      ...
      >
        <div className="container">
          ...
          <section>
            {topicsArray
              .filter(topicObj => topicObj.topic === "Cats")
              .map((topicObj, index) => {
                const topic = topicObj.topic
...
export const Head = () => <Seo title="Cats" />
