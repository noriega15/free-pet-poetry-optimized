...
const ReptilesPage = ({ data, location }) => {
  ...
  // Calculate total pages Reptiles
  const totalPosts = postsByTopic["Reptiles"]
    ? postsByTopic["Reptiles"].length
    : 0
    ...
    <Layout location={location} title={siteTitle}>
      ...
      >
        <div className="container">
          ...
          <section>
            {topicsArray
              .filter(topicObj => topicObj.topic === "Reptiles")
              .map((topicObj, index) => {
                const topic = topicObj.topic
...
export const Head = () => <Seo title="Reptiles" />
