...
const PetCarePage = ({ data, location }) => {
  ...
  // Calculate total pages Pet Care
  const totalPosts = postsByTopic["Pet Care"]
    ? postsByTopic["Pet Care"].length
    : 0
    ...
    <Layout location={location} title={siteTitle}>
      ...
      >
        <div className="container">
          ...
          <section>
            {topicsArray
              .filter(topicObj => topicObj.topic === "Pet Care")
              .map((topicObj, index) => {
                const topic = topicObj.topic
                ...
                return (
                  ...
                  >
                    <h2 className="headline headline-2 section-title">
                      <span className="span">{topic} Tips</span>
                    </h2>
...
export const Head = () => <Seo title="Pet Care" />
