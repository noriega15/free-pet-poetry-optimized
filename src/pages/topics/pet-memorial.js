...
const PetMemorialPage = ({ data, location }) => {
  ...
  const totalPosts = postsByTopic["Pet Memorial"]
    ? postsByTopic["Pet Memorial"].length
    : 0
    ...
    <Layout location={location} title={siteTitle}>
      ...
      >
        <div className="container">
          ...
          <section>
            {topicsArray
              .filter(topicObj => topicObj.topic === "Pet Memorial")
              .map((topicObj, index) => {
                const topic = topicObj.topic
...
export const Head = () => <Seo title="Pet Memorial" />

export default PetMemorialPage
