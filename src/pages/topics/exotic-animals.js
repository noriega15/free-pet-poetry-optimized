...
const ExoticAnimalsPage = ({ data, location }) => {
  ...
  // Calculate total pages Exotic Animals
  const totalPosts = postsByTopic["Exotic Animals"]
    ? postsByTopic["Exotic Animals"].length
    : 0
    ...
    <Layout location={location} title={siteTitle}>
      ...
      >
        <div className="container">
          ...
          <section>
            {topicsArray
              .filter(topicObj => topicObj.topic === "Exotic Animals")
              .map((topicObj, index) => {
                const topic = topicObj.topic
...
export const Head = () => <Seo title="Exotic Animals" />

export default ExoticAnimalsPage
