...
const SmallPetsPage = ({ data, location }) => {
  ...
  // Calculate total pages Small Pets
  const totalPosts = postsByTopic["Small Pets"]
    ? postsByTopic["Small Pets"].length
    : 0
    ...
    <Layout location={location} title={siteTitle}>
      ...
      >
        <div className="container">
          ...
          <section>
            {topicsArray
              .filter(topicObj => topicObj.topic === "Small Pets")
              .map((topicObj, index) => {
                const topic = topicObj.topic
...
export const Head = () => <Seo title="Small Pets" />
